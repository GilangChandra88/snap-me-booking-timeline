                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            variant="outline"
                            onClick={() => {
                                const caption = `Hallo kak, ini hasil fotonya ya \u{1F64C}\n${booking.driveLink}\nJangan lupa di-download ya kak, karena file di drive hanya bertahan selama 1 bulan \u{1F60A}\nKalau kakak berkenan, boleh banget tag @snapme_singaraja saat upload di Instagram Story.\n\nTerima kasih banyak sudah mempercayakan momen kakak ke kami \u{1F929}\u{1F4F8}\n\n_Snap Me Self Photo, Where moments come alive_`;
